        ...
        {user ? (
          <div className='flex items-center gap-2 sm:gap-3'>
            <button
              ...
              className='cursor-pointer flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'
            ...
            <div className='relative group'>
              ...
              <div className='absolute hidden group-hover:block top-0 right-0 z-10 rounded pt-12'>
                <ul className='list-none m-0 p-2 border-white bg-white rounded-md text-sm shadow'>
                  <li>
                    <button
                      onClick={logout}
                      className='py-1 px-2 cursor-pointer pr-10 w-full text-left'
                    >
                      Logout
                    </button>
                  </li>
